...
function panadero_bakery_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'panadero_bakery_site_title_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'panadero_bakery_site_title_color', array(
		'label' => 'Title Color',
		'section' => 'title_tagline',
	)));
	...
	$wp_customize->add_setting( 'panadero_bakery_site_tagline_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'panadero_bakery_site_tagline_color', array(
		'label' => 'Tagline Color',
		'section' => 'title_tagline',
	)));
	...
	$wp_customize->add_setting( 'panadero_bakery_boxfull_width', array(
		'default'           => '',
		'sanitize_callback' => 'panadero_bakery_sanitize_choices'
	));
	
	$wp_customize->add_control( 'panadero_bakery_boxfull_width', array(
		'label'    => __( 'Section Width', 'panadero-bakery' ),
		'section'  => 'panadero_bakery_theme_options_section',
		'type'     => 'select',
		'choices'  => array(
			'container'  => __('Box Width', 'panadero-bakery'),
			'container-fluid' => __('Full Width', 'panadero-bakery'),
			'none' => __('None', 'panadero-bakery')
		),
	));

	$wp_customize->add_setting( 'panadero_bakery_dropdown_anim', array(
		'default'           => 'None',
		'sanitize_callback' => 'panadero_bakery_sanitize_choices'
	));
	$wp_customize->add_control( 'panadero_bakery_dropdown_anim', array(
		'label'    => __( 'Menu Dropdown Animations', 'panadero-bakery' ),
		'section'  => 'panadero_bakery_theme_options_section',
		'type'     => 'select',
		'choices'  => array(
			'bounceInUp'  => __('bounceInUp', 'panadero-bakery'),
			'fadeInUp' => __('fadeInUp', 'panadero-bakery'),
			'zoomIn'    => __('zoomIn', 'panadero-bakery'),
			'None'    => __('None', 'panadero-bakery')
		),
	));
	...
	$wp_customize->add_setting( 'panadero_bakery_slidertitle_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'panadero_bakery_slidertitle_color', array(
		'label' => 'Title Color',
		'section' => 'panadero_bakery_slider_section',
	)));

	$wp_customize->add_setting( 'panadero_bakery_slidertext_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'panadero_bakery_slidertext_color', array(
		'label' => 'Text Color',
		'section' => 'panadero_bakery_slider_section',
	)));

	$wp_customize->add_setting( 'panadero_bakery_sliderbtn_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'panadero_bakery_sliderbtn_color', array(
		'label' => 'Button Text Color',
		'section' => 'panadero_bakery_slider_section',
	)));

	$wp_customize->add_setting( 'panadero_bakery_sliderbtnbg_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'panadero_bakery_sliderbtnbg_color', array(
   ...
   $wp_customize->add_setting( 'panadero_bakery_feature_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'panadero_bakery_feature_color', array(
		'label' => 'Heading Color',
		'section' => 'panadero_bakery_product_section',
	)));

	$wp_customize->add_setting( 'panadero_bakery_featuretext_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'panadero_bakery_featuretext_color', array(
		'label' => 'Text Color',
		'section' => 'panadero_bakery_product_section',
	)));
	...
	//Footer
 	$wp_customize->add_section( 'panadero_bakery_footer', array(
    	'title'      => __( 'Footer Setting', 'panadero-bakery' ),
		'priority'   => null,
		'panel' => 'panadero_bakery_panel_id'
	) );
	...
	$wp_customize->add_control('panadero_bakery_footer_link',array(
		'label'	=> __('Copyright Link','panadero-bakery'),
		'section'	=> 'panadero_bakery_footer',
	...
	$wp_customize->add_control('panadero_bakery_footer_copy',array(
		'label'	=> __('Copyright Text','panadero-bakery'),
		'section'	=> 'panadero_bakery_footer',
	...
	$wp_customize->add_setting( 'panadero_bakery_copyright_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'panadero_bakery_copyright_color', array(
		'label' => 'Text Color',
		'section' => 'panadero_bakery_footer',
	)));

	$wp_customize->add_setting( 'panadero_bakery_copyrightbg_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'panadero_bakery_copyrightbg_color', array(
