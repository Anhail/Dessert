...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Bakery_Confectionery_Toggle_Switch_Custom_Control extends WP_Customize_Control {
...
if ( class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 * Upsell section
	 */
	class Bakery_Confectionery_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'bakery-confectionery-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="bakery_confectionery_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
